            ...
            <div class="col-md-12">
                <form method="post" action="traitement.php" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <label><strong>Lien facebook</strong></label>
                            <input name="lien_facebook" type="text" placeholder="Taper le lien facebook" class="form-control">
                        </div>
                        <div class="form-group col-sm-12">
                            <label><strong>Lien twitter</strong></label>
                            <input name="lien_twitter" type="text" placeholder="Taper le lien twitter" class="form-control">
                        </div>
                        <div class="form-group col-sm-12">
                            <label><strong>Lien linkedin</strong></label>
                            <input name="lien_linkedin" type="text" placeholder="Taper le lien linkedin" class="form-control">
                        </div>
                        <div class="col-sm-12">
