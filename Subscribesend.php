<?php	
	...
	//define('GUSER', 'username'); // username is here
	//define('GPWD', 'password'); // password is here
						...
						<tr>
						  <td><table width='100%' cellspacing='0' cellpadding='12' border='1' bordercolor='#919191'>
							  ...
							  <tr>
								...
								<td align='left'><font face='Arial, Helvetica, sans-serif' size='4'>$CompanyName</font></td>
							  </tr>
							  <tr>
