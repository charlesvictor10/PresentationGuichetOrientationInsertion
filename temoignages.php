    ...
    <div class="container">
        <div class="row wow fadeInDown">
            <div class="col-md-12 margin-top-30">
                ...
                <p><a href="ajoutPartenaire.php" class="btn-small btn-blue btn-effect">Nouveau témoignage</a></p>
                <table class="table table-bordered">
                    <thead>
                    <tr>
                        <th class="tc-1">Numéro</th>
                        <th class="tc-2">Nom</th>
                        <th class="tc-3">Métier</th>
                        <th class="tc-4">message</th>
                    ...
                    foreach($temoins as $temoin){
                        ?>
                        <tr>
                            <td class="tc-1"><?php echo $temoin['id']; ?></td>
                            <td class="tc-2"><?php echo $temoin['nom']; ?></td>
                            <td class="tc-3"><?php echo $temoin['metier']; ?></td>
                            <td class="tc-4"><?php echo $temoin['file_name']; ?></td>
